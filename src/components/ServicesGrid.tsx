    ...
    <section className="py-20 bg-background" id="services">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-slide-up">
          <h2 className="text-5xl font-black text-accent mb-6 font-display">Government Services</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-accent mb-4">{service.category}</h3>
              
              <ul className="space-y-3 mb-6">
                {service.items.map((item) => (
                  <li key={item} className="flex items-center text-accent">
              ...
              <button className="w-full btn-primary text-accent py-3 rounded-lg font-semibold">
        ...
        <div className="mt-16 glass-card rounded-2xl p-8">
          <h3 className="text-2xl font-bold text-accent mb-8 text-center">Quick Actions</h3>
          <div className="grid md:grid-cols-4 gap-6">
            <button className="flex flex-col items-center p-6 rounded-xl hover:bg-secondary/20 transition-all hover-lift group">
              ...
              <span className="font-semibold text-accent">Search Services</span>
              <span className="text-sm text-accent mt-1">Find by keywords</span>
            </button>
            ...
            <button className="flex flex-col items-center p-6 rounded-xl hover:bg-secondary/20 transition-all hover-lift group">
              ...
              <span className="font-semibold text-accent">Saved Applications</span>
              <span className="text-sm text-accent mt-1">Continue drafts</span>
            </button>
            ...
            <button className="flex flex-col items-center p-6 rounded-xl hover:bg-secondary/20 transition-all hover-lift group">
              ...
              <span className="font-semibold text-accent">Application History</span>
              <span className="text-sm text-accent mt-1">View past submissions</span>
            </button>
            ...
            <button className="flex flex-col items-center p-6 rounded-xl hover:bg-secondary/20 transition-all hover-lift group">
              ...
              <span className="font-semibold text-accent">Help & Support</span>
              <span className="text-sm text-accent mt-1">Get assistance</span>
            </button>
          </div>
        </div>
      </div>
